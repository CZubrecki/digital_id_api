...
let AuthService = class AuthService {
    constructor(usersService, secureDetailsService, jwtService) {
        this.usersService = usersService;
        this.secureDetailsService = secureDetailsService;
    ...
    async validateUserPassword(input, hashedPassword) {
        return bcrypt_1.compare(input, hashedPassword).then((result) => (result));
    }
    async login(user) {
...
AuthService = __decorate([
    ...
    __metadata("design:paramtypes", [users_service_1.UsersService,
        secure_details_service_1.SecureDetailsService,
        jwt_1.JwtService])
], AuthService);
